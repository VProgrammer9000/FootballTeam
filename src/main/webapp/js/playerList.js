/**
 * view-controller for playerList.html
 * @author Marcel Suter
 */
let delayTimer;
...
function showBooklist(data) {
    ...
    if (userRole === "user" || userRole === "admin") {
        document.getElementById("addButton").innerHTML = "<a href='./playerEdit.html'>Neues Buch</a>";
    }
}
...
function editBook(event) {
    ...
    window.location.href = "./playerEdit.html?uuid=" + bookUUID;
}
